        ...
        <div className={styles.page}>
            ...
            <div className={styles.heading}>
                <div>
                    ...
                    <p>
                        Set the physical AED and USDT holdings when
                        starting the ledger.
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <div className={styles.field}>
                    <label>USDT Opening Balance</label>
                ...
                <div className={styles.warning}>
                    Opening balances establish the initial physical
                    holdings of the business. They are recorded in
                    the ledger and cannot be created twice.
                </div>
